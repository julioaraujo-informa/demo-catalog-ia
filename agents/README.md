# 🤖 Agents Collections - Marlabs

Este catálogo reúne uma coleção de **agents de IA para Visual Studio Code**.
...
|------|----------|-----------|
| 🔍 **Code Review Agent** | Analisa código, sugere melhorias, identifica bugs e más práticas | [Copiar Agent](./code-review.agent.md) |
